...
export function Velaris({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      canvas.height = (container.clientHeight || 500) * dpr
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#07090e] via-[#07090e]/60 to-transparent z-0" />
